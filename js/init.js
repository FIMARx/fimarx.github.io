...
function edrea_tm_page_transition() {
    ...
    button.on('click', function () {
        ...
        if (!parent.hasClass('active')) {
            ...
            wrapper
                .find(section)
                .removeClass('animated ' + enter);
            if (wrapper.hasClass('opened')) {
                wrapper
                    .find(section)
                    .addClass('animated ' + exit);
            }
        ...
        .on('click', function () {
            ...
            modalBox
                ...
                .prepend(
                    ...
                    '" data-img-url="' + image + '"></div></div>'
                );
            modalBox
                .find('.portfolio_popup_details .top_image')
                .after(
                    '<div class="portfolio_main_title"><h3>' + title + '</h3><span><a href="#">' +
                    category + '</a></span><div>'
                );
            edrea_tm_data_images();
            edrea_tm_popup();
    ...
    button
        ...
        .on('click', function () {
            ...
            modalBox
                ...
                .after(
                    '<div class="news_main_title"><h3>' + title + '</h3><span>' + category + '</spa' +
                    'n><div>'
                );
            edrea_tm_data_images();
            return false;
...
function edrea_tm_popup() {
    ...
    jQuery('.popup-youtube, .popup-vimeo').each(
        function () { // the containers for all your galleries
            jQuery(this).magnificPopup({
                disableOn: 700,
                type: 'iframe',
...
function edrea_tm_contact_form() {
    ...
    jQuery(".contact_form #sendMessageButton").on('click', function (event) {
...
function currentLink(ccc, e) {
    ...
    var menuleft = $('.edrea_tm_header .menu')
        .offset()
        .left;
    e
        .parent()
